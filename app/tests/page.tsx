...
export const metadata: Metadata = {
  title: "전체 심심풀이 심리 테스트 | 성격 테스트 모음",
  description:
    "모든 심심풀이 심리 테스트와 성격 테스트를 한눈에 확인하세요. 무료 온라인 심리 검사: 스트레스 체크, 진로 가치관 탐색, 애착 유형, 리더십 진단, 학습 성향 등 다양한 심심풀이 테스트를 제공합니다.",
  keywords: [
    "심리 테스트",
    "성격 테스트",
    "심심풀이",
  ...
  openGraph: {
    title: "전체 심심풀이 심리 테스트 | 성격 테스트 모음",
    description:
      "모든 심심풀이 심리 테스트와 성격 테스트를 한눈에 확인하세요. 무료 온라인 심리 검사를 제공합니다.",
    url: `${siteUrl}/tests`,
    type: "website",
  },
  alternates: {
        ...
        <section className="rounded-3xl bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-800 p-10 text-white shadow-xl shadow-indigo-500/20">
          <div className="flex flex-col gap-6">
            ...
            <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl md:text-5xl">
              심심풀이 심리 테스트 & 성격 테스트 전체
            </h1>
            <p className="max-w-3xl text-base leading-relaxed text-indigo-100 sm:text-lg">
              심심할 때 해보는 무료 심리 테스트와 성격 테스트 모음입니다. 아래
              테스트는 자체 설계 및 전문 심리상담사와 협업 중인 라인업입니다. 각
              카드에서 소요 시간, 문항 수, 추천 대상 정보를 확인하고 자세히
              보기로 이동해 주세요.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-10">
          <header className="flex flex-col gap-2">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-300">
              새로운 심리 테스트와 성격 테스트는 매달 순차적으로 업데이트됩니다.
              필요하신 심심풀이 검사가 보이지 않는다면 페이지 하단에서 요청해
              주세요.
            </p>
          </header>
